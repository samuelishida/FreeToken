...
server boot as serving support; use the target matrix and commands from the
review evidence. Initial validation uses this exact tuple:

| component | validation tuple |
| --- | --- |
...
Current ROCm target matrix (Inc 13):
