...
class BackendInfo:
    ...
    # Whether this backend can coexist with models that interleave linear/GDN
    # layers. Linear layers bypass attention backend dispatch, but backends with
    # layer-index or graph assumptions may explicitly opt out.
